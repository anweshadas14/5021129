public class Main {
    public static void main(String[] args) {
        ...
        Employee emp1 = new Employee(1, "Anwesha", "Android Developer", 60000);
        Employee emp2 = new Employee(2, "Abhi", "Project Manager", 30000);
        Employee emp3 = new Employee(3, "Ayushi", "Data Analyst", 90000);
        ...
        Employee emp4 = new Employee(4, "Mia", "Software Designer", 59000);
