...
public class BookSearch {
    ...
    public static void main(String[] args) {
        Book[] books = {
            new Book(1, "Computer Networks", "Jane Smith"),
            new Book(2, "Data Structures", "Mili Doe"),
            new Book(3, "Database mangement Systems", "Alice Lare"),
            new Book(4, "Operating Systems", "Freed Johnson")
        };
